  ...
  useEffect(() => {
    if (isVisible) {
      ...
      const percentInterval = setInterval(() => {
        if (startPercent < 70) {
          startPercent++;
          setAnimatedNumbers(prev => ({ ...prev, percent: startPercent }));
        } else {
      ...
      const ratioInterval = setInterval(() => {
        if (startRatio < 5000) {
          startRatio += 100;
          setAnimatedNumbers(prev => ({ ...prev, ratio: startRatio }));
        } else {
      ...
      const distanceInterval = setInterval(() => {
        if (startDistance < 80) {
          startDistance++;
          setAnimatedNumbers(prev => ({ ...prev, distance: startDistance }));
        } else {
      ...
      // Animate #6
      setTimeout(() => {
        setAnimatedNumbers(prev => ({ ...prev, rank: 6 }));
      }, 500);
    }
  }, [isVisible]);
  ...
  return (
    <section ref={sectionRef} className="problem-section">
      ...
      <div className="problem-container">
        ...
        {/* Stats Grid with Icons - Numbers count up when visible */}
        <div className="stats-grid">
          <div className="stat-card">
            <div className="stat-icon">
              <Users />
            </div>
            <div className="stat-number">{animatedNumbers.percent}%</div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-number">1:{animatedNumbers.ratio.toLocaleString()}</div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-number">{animatedNumbers.distance}km+</div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-number">#{animatedNumbers.rank}</div>
