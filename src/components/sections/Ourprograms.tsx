...
const MedicalCenterIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" stroke="#16a34a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M12 6v6M9 9h6" stroke="#16a34a" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
...
const EducationIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z" stroke="#22c55e" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z" stroke="#22c55e" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
const programs = [
  {
    ...
    description: 'A growing hub for primary care, diagnostics, maternal health services and healthcare workforce training in Ufuma, Nigeria.',
  },
  {
    id: 2,
    icon: <OutreachIcon />,
    ...
    description: 'Providing free consultations, medications, screenings and referrals to underserved communities across Nigeria.',
  },
  {
    id: 3,
    icon: <SkillsIcon />,
    iconBg: '#faf5ff',
    tag: 'Training',
    title: 'Skills Acquisition Center',
  ...
  },
  {
    ...
    description: 'Expanding access to safe pregnancy care, delivery support, newborn care, and maternal education for families.',
  },
  {
    id: 5,
    ...
    description: 'Building the physical foundations for sustainable, high-quality healthcare delivery across underserved regions.',
  },
  {
    id: 6,
    icon: <EducationIcon />,
    ...
    description: 'Empowering individuals and families with vital health knowledge, disease prevention strategies and wellness practices.',
  },
];
    ...
    <div style={{ fontFamily: "'Inter', 'Segoe UI', sans-serif" }}>
      ...
      <style>{`
        ...
        .programs-hero::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse at 70% 50%, rgba(34,197,94,0.15) 0%, transparent 65%);
          pointer-events: none;
        }
        .programs-hero h1 {
          color: #ffffff;
