...
const StethoscopeIcon = () => (
  <svg width="52" height="52" viewBox="0 0 24 24" fill="none">
    <path d="M7 3v6a5 5 0 0010 0V3" stroke="#1e3a8a" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M17 14v1a4 4 0 01-4 4H9" stroke="#1e3a8a" strokeWidth="1.5" strokeLinecap="round"/>
    <circle cx="7.5" cy="19.5" r="2" stroke="#1e3a8a" strokeWidth="1.5"/>
  </svg>
);
const ThermometerIcon = () => (
  <svg width="52" height="52" viewBox="0 0 24 24" fill="none">
    <path d="M14 14.76V3.5a2.5 2.5 0 00-5 0v11.26a4.5 4.5 0 105 0z" stroke="#1e3a8a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
const MegaphoneIcon = () => (
  <svg width="52" height="52" viewBox="0 0 24 24" fill="none">
    <path d="M3 11l19-9-9 19-2-8-8-2z" stroke="#1e3a8a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
const HomeIcon = () => (
  <svg width="52" height="52" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M9 22V12h6v10" stroke="#1e3a8a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
  ...
  return (
    <section className="programs-hero">
      ...
      <div style={{
        ...
        background: 'linear-gradient(to right, rgba(13,31,78,0.88) 0%, rgba(30,58,138,0.65) 70%, rgba(13,31,78,0.20) 100%)',
      }} />
  ...
  <section className="programs-overview">
    ...
    <div style={{ maxWidth: '1080px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div className="programs-feature-row">
        ...
        {/* Medical Center — navy blue */}
        <div style={{ backgroundColor: '#0d1f4e', borderRadius: '16px', overflow: 'hidden', padding: '28px 28px 0' }}>
          <div style={{
            backgroundColor: '#ffffff', borderRadius: '10px', padding: '24px',
            marginBottom: '16px', display: 'inline-flex', alignItems: 'center',
            justifyContent: 'center', gap: '12px', minWidth: '100%', boxSizing: 'border-box',
          }}>
          ...
          <div style={{ padding: '20px 0 24px' }}>
            ...
            <a href="#" style={{ color: '#93c5fd', fontSize: '13px', fontWeight: '700', textDecoration: 'none' }}>Learn More →</a>
          </div>
        </div>

        {/* Skills Acquisition — medium navy */}
      ...
      <div className="programs-small-row">
        {smallCards.map((p, i) => (
          <div key={i} style={{ backgroundColor: '#f0f4ff', borderRadius: '14px', overflow: 'hidden', border: '1px solid #dbeafe' }}>
            <div className="small-card-top">
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', backgroundColor: '#eff6ff' }}>
                {p.icon}
              </div>
              <img src={p.img} alt={p.title} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
            </div>
            <div style={{ padding: '20px 20px 24px' }}>
              <p style={{ color: '#1e3a8a', fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '6px' }}>{p.category}</p>
              ...
              <a href="#" style={{ color: '#1e3a8a', fontSize: '13px', fontWeight: '700', textDecoration: 'underline' }}>Learn More</a>
            </div>
          </div>
        ))}
      </div>
  ...
  <div style={{ fontFamily: "'Inter', sans-serif" }}>
    <style>{`
      ...
      @media (max-width: 760px) {
        .programs-hero { min-height: 320px; align-items: flex-end; }
